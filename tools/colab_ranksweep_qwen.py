# CONSULT-2 follow-up (Colab GPU): Qwen rank sweep: does LoRA r32 acquire t2 where r8 didn't? Null (t2=0 both) = adapter capacity not binding at this dose.
# Paste this whole file into ONE Colab cell and run. Paste ALL cell output back.
# Qwen rank sweep: does LoRA r32 acquire t2 where r8 didn't? Null (t2=0 both) = adapter capacity not binding at this dose.
...
ARMS = [('r8-hard', 8, 16, 'hard36'), ('r32-hard', 32, 64, 'hard36')]
